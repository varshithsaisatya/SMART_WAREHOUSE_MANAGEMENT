...
const AppShell = lazy(() => import("./components/app-shell.tsx"));
const Dashboard = lazy(() => import("./pages/Dashboard.tsx"));
const Orders = lazy(() => import("./pages/Orders.tsx"));
const OrderDetail = lazy(() => import("./pages/OrderDetail.tsx"));
const Inventory = lazy(() => import("./pages/Inventory.tsx"));
const InventoryDetail = lazy(() => import("./pages/InventoryDetail.tsx"));
const Allocation = lazy(() => import("./pages/Allocation.tsx"));
const Picking = lazy(() => import("./pages/Picking.tsx"));
const Packing = lazy(() => import("./pages/Packing.tsx"));
const Dispatch = lazy(() => import("./pages/Dispatch.tsx"));
const Exceptions = lazy(() => import("./pages/Exceptions.tsx"));
